...
import com.example.bicolwallet.databinding.ActivityCustomerPayoutBinding;
import com.hbb20.CountryCodePicker;

public class CustomerPayout extends AppCompatActivity {

    ActivityCustomerPayoutBinding binding;
    private Boolean valid;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding= ActivityCustomerPayoutBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());


        binding.customerToolbar.toolbarTitle.setText("Pay Out");
