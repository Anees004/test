...
import com.example.bicolwallet.databinding.FragmentDeniedBinding;
...
public class DeniedSendFragment extends Fragment {

    private FragmentDeniedBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {


        binding = FragmentDeniedBinding.inflate(inflater, container, false);
    ...
    void initRecycularAdapter(dataclass v) {
        ...
        binding.deniedSendRequestRecycular.setAdapter(adapter);
        binding.deniedSendRequestRecycular.setLayoutManager(new LinearLayoutManager(getContext()));
    }
